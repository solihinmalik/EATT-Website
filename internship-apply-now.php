    ...
    <section>
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            ...
            Ready to take the next step in your career? Apply now and be part of our innovative team!
          </p>
          </div>
        ...
        <div class="row">
          <div>
            <div class="aapply-box" data-aos="fade-up" data-aos-delay="100">
              <h3 class="box-title"><strong>INTERNSHIP APPLICATION FORM</strong></h3>

              <!-- FORM WEB VIEW -->
              <form class="form-intern-apply" id="EmploymentApplication100" method="post" onsubmit="return CustomSubmit();">
                <script type="text/javascript">
                  ...
                  function CustomSubmit() {
                    ...
                    if (ValidateForm(form)) {
                      ...
                      var subject = 'Internship Application Submission';
                      var body = 'Dear Hiring Team,\n\nPlease find below the details of my internship application:\n\n';
                      ...
                      var fieldsToInclude = [
                        'Full_Name', 'Gender', 'Email_Address', 'Phone', 'Working_Experience', 'Education_Level',
                        'Academic_Institution', 'Portfolio_Website', 'Course_Name', 'Internship_Focus',
                        'Internship_Duration', 'Skills'
                  ...
                  function ValidateForm(frm) {
                    ...
                    if (frm.Working_Experience.value == "") { alert('Working experience is required.'); frm.Working_Experience.focus(); return false; }
                ...
                <table class="applyy" border="0" cellpadding="13" cellspacing="1">
                  ...
                  <td>
                      <label for="Working_Experience"><b>Working Experience * (if any)</b></label><br />
                      <input name="Working_Experience" type="text" maxlength="100" style="width:100%;" />
                    </td>

                    <td >
                      <label for="Education_Level"><b>Education Level *</b></label><br />
                      <select data-placeholder="Select Education Level" class="chosen-select" name="Education_Level" style="width:100%;">
                          <option value=""></option>
                        <option value="Diploma">Diploma</option>
                        <option value="Bachelor's Degree">Bachelor's Degree</option>
                        <option value="Master's Degree">Master's Degree</option>
                        <option value="Vocational and Technical">Vocational and Technical</option>
                  ...
                  <td>
                      <label for="Academic_Institution"><b>Academic Institution / University</b></label><br /> <input name="Academic_Institution" type="text"
                        maxlength="50" style="width:100%;" />
                  </td>

                      <td>
                            <label for="Course_Name"><b>Course Name / Study Field</b></label><br />
                            <input name="Course_Name" type="text" maxlength="100" style="width:100%;" />
                      </td>
                  ...
                  <td >
                      ...
                      <td >
                            <label for="Internship_Focus"><b> Internship Focus / Scope *</b></label><br />
                            <select data-placeholder="Select Internship Scope" class="chosen-select" name="Internship_Focus" style="width:100%;">
                              <option value=""></option>
                      ...
                      <td>
                          <label for="Internship_Duration"><b>Internship Duration *</b></label><br />
                          <div class="internship-duration">
                            <input type="number" name="Internship_Duration" id="internshipDuration" style="width: 70%;" min="1" max="12" required>
              ...
              <!-- FORM MOBILE VIEW -->
              <form class="form-intern-apply-mobile" id="EmploymentApplication100" method="post" onsubmit="return CustomSubmit();">
                <script type="text/javascript">
